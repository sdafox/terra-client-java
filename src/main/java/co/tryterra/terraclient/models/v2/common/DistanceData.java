...
public class DistanceData {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof DistanceData)) return false;
        final DistanceData other = (DistanceData) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DistanceData;
    }
    ...
    public String toString() {
        return "DistanceData(summary=" + this.getSummary() + ", detailed=" + this.getDetailed() + ")";
    }
    ...
    public static class Summary {
        ...
        public boolean equals(final Object o) {
            ...
            if (this$elevation == null ? other$elevation != null : !this$elevation.equals(other$elevation))
                return false;
            return true;
        }
        ...
        public String toString() {
            return "DistanceData.Summary(floorsClimbed=" + this.getFloorsClimbed() + ", steps=" + this.getSteps() + ", distanceMeters=" + this.getDistanceMeters() + ", swimming=" + this.getSwimming() + ", elevation=" + this.getElevation() + ")";
        }
        ...
        public static class Swimming {
            ...
            public String toString() {
                return "DistanceData.Summary.Swimming(numStrokes=" + this.getNumStrokes() + ", numLaps=" + this.getNumLaps() + ", poolLengthMeters=" + this.getPoolLengthMeters() + ")";
            }
        }
        ...
        public static class Elevation {
            ...
            public String toString() {
                return "DistanceData.Summary.Elevation(lossActualMeters=" + this.getLossActualMeters() + ", minMeters=" + this.getMinMeters() + ", avgMeters=" + this.getAvgMeters() + ", gainActualMeters=" + this.getGainActualMeters() + ", maxMeters=" + this.getMaxMeters() + ", gainPlannedMeters=" + this.getGainPlannedMeters() + ")";
            }
        }
    ...
    public static class Detailed {
        ...
        public boolean equals(final Object o) {
            ...
            if (this$stepSamples == null ? other$stepSamples != null : !this$stepSamples.equals(other$stepSamples))
                return false;
            final Object this$floorsClimbedSample = this.getFloorsClimbedSample();
            final Object other$floorsClimbedSample = other.getFloorsClimbedSample();
            if (this$floorsClimbedSample == null ? other$floorsClimbedSample != null : !this$floorsClimbedSample.equals(other$floorsClimbedSample))
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            final Object $floorsClimbedSample = this.getFloorsClimbedSample();
            result = result * PRIME + ($floorsClimbedSample == null ? 43 : $floorsClimbedSample.hashCode());
            return result;
        }

        public String toString() {
            return "DistanceData.Detailed(distanceSamples=" + this.getDistanceSamples() + ", elevationSamples=" + this.getElevationSamples() + ", stepSamples=" + this.getStepSamples() + ", floorsClimbedSample=" + this.getFloorsClimbedSample() + ")";
        }
    }
